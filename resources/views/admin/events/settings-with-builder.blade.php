...
<div class="container mx-auto max-w-screen-xl px-4 lg:px-6 py-6 space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        @endif
        <div class="relative flex flex-col lg:flex-row gap-6 items-start overflow-visible">
            <div class="flex flex-col gap-2 w-36 shrink-0 lg:sticky lg:top-24 relative z-20">
            ...
            <div class="w-full flex-1 basis-0 min-w-0 relative z-10">
            ...
            <div class="w-full lg:w-80 lg:shrink-0 max-w-full relative z-10">
