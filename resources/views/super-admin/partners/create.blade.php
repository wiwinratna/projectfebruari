...
@section('page-title')
    Add Partner <span class="bg-blue-500 text-white text-sm px-2 py-1 rounded-full ml-2">Super Admin</span>
@endsection
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Add New Partner</h2>
        <p class="text-gray-500 text-sm -mt-4 mb-6">This partner will appear in the Our Partners section of the landing page.</p>
        ...
        <form method="POST" action="{{ route('super-admin.partners.store') }}" enctype="multipart/form-data" class="space-y-6 max-w-2xl">
            @csrf
