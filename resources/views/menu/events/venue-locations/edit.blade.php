...
@section('title', 'Edit Venue Location - ' . $event->title)
@section('page-title')
Edit Venue Location <span class="bg-red-500 text-white text-sm px-2 py-1 rounded-full ml-2">{{ $event->title }}</span>
@endsection
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Edit Venue Location</h2>
            <p class="text-gray-600 mt-1">Update venue location information</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <form action="{{ route('admin.events.venue-locations.update', [$event, $venueLocation]) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text"
                        id="gugus"
                        name="gugus"
                        value="{{ old('gugus', $venueLocation->gugus) }}"
                ...
                <div>
                    ...
                    <input type="text"
                        id="nama"
                        name="nama"
                        value="{{ old('nama', $venueLocation->nama) }}"
            ...
            <div>
                ...
                <input type="text"
                    id="alamat"
                    name="alamat"
                    value="{{ old('alamat', $venueLocation->alamat) }}"
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i> Update Venue Location
                </button>
            </div>
        </form>
    </div>
