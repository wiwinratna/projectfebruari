...
@section('title', 'Tambah Venue Access - ' . $event->title)
@section('page-title')
Tambah Venue Access <span class="bg-red-500 text-white text-sm px-2 py-1 rounded-full ml-2">{{ $event->title }}</span>
@endsection
        ...
        <form action="{{ route('admin.events.venue-accesses.store', $event) }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="nama_vanue" name="nama_vanue" value="{{ old('nama_vanue') }}"
