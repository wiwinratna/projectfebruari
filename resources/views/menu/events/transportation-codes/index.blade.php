...
@section('title', 'Kode Transportasi - ' . $event->title)
@section('page-title')
Kode Transportasi <span class="bg-red-500 text-white text-sm px-2 py-1 rounded-full ml-2">{{ $event->title }}</span>
@endsection
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-800">Semua Kode Transportasi</h3>
        </div>
                    ...
                    <tr>
                        <td colspan="3" class="px-6 py-12 text-center">
                            <div class="text-gray-500">
                                ...
                                <p class="text-lg font-medium">No transportation codes found</p>
                                <p class="text-sm">Create your first transportation code to get started</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
...
<script>
    function deleteItem(id, name) {
        showConfirmModal('Delete Kode Transportasi', 'Are you sure you want to delete this code?', `Kode: "${name}"`, () => performDelete(id));
    }
