...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Edit Kode Transportasi</h2>
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <form action="{{ route('admin.events.transportation-codes.update', [$event, $transportationCode]) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label for="kode" class="block text-sm font-medium text-gray-700 mb-2">Kode <span class="text-red-500">*</span></label>
                    <input type="text" id="kode" name="kode" value="{{ old('kode', $transportationCode->kode) }}"
                ...
                <div>
                    ...
                    <input type="text" id="keterangan" name="keterangan" value="{{ old('keterangan', $transportationCode->keterangan) }}" maxlength="1000"
