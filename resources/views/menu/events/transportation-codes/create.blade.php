...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Create New Transportation Code</h2>
...
document.addEventListener('DOMContentLoaded', () => {
  // TomSelect for icon dropdown (and any .ts-select)
  ...
  // Preview logic (fallback: icon if chosen, else code if typed)
  ...
  function renderPreview(){
    const icon = iconSelect?.value || '';
        ...
        // ini artinya data kamu masih salah / ada record lama
        preview.innerHTML = '<span class="text-red-500 text-xs">Icon value invalid (SVG stored). Reset icon_key.</span>';
        return;
        }
