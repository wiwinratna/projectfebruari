        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-3xl font-bold text-yellow-400">O</span>
              <span className="text-3xl font-bold text-red-500">C</span>
              <span className="text-3xl font-bold text-green-400">I</span>
              <span className="text-3xl font-bold text-purple-400">S</span>
            </div>
          ...
          >
            ...
            <ul className="space-y-3">
              {['Job Openings', 'About NOCIS', 'Our Partners', 'Events', 'Contact Us'].map((item) => (
                <li key={item}>
                  <motion.a
                    href="#"
                    whileHover={{ x: 5 }}
